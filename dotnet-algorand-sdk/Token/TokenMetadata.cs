...
namespace Algorand.Token
{
    ...
    public class TokenMetadata
    {
        ...
        /// (https://w3c.github.io/webappsec-subresource-integrity).
        /// </summary>
        public string Animation_url_integrity { get; set; }
        ...
        /// </summary>
        public string Animation_url_mimetype { get; set; }
        ...
        /// </summary>
        public string Extra_metadata { get; set; }
        ...
        {
            return JsonConvert.DeserializeObject<TokenMetadata>(json);
        }
